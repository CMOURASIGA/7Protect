...
export type PlanningCycle = EntityMetadata & { clientId: string; name: string; status: "draft" | "active" | "closed"; startedAt: string; suggestedReviewAt?: string; acceptedProposalVersionId?: string };
